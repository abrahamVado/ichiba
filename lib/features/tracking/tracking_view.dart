...
class _TrackingViewState extends State<TrackingView> {
  ...
  void initState() {
    super.initState();
    //1.- Kick off the subscription to rider updates after the first frame.
  ...
  @override
  void dispose() {
    //2.- Stop listening when the view is destroyed.
  ...
  Widget build(BuildContext context) {
    //3.- React to tracking updates via a Consumer widget.
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    //4.- Display each rider entry with simple formatting.
